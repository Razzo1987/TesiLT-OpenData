...
\begin{titlepage}
\begin{center}
{{\Large{\textsc{Universitˆ degli Studi di Milano Bicocca}}}} \rule[0.1cm]{15.8cm}{0.1mm}
\rule[0.5cm]{15.8cm}{0.6mm}
{\small{\bf Dipartimento di Informatica, Sistemistica e Comunicazione\\
Corso di laurea in Informatica}}
\end{center}
\vspace{15mm}
\begin{center}
{\LARGE{\bf Realizzazione di}}\\
\vspace{3mm}
{\LARGE{\bf una piattaforma per}}\\
\vspace{3mm}
{\LARGE{\bf l'erogazione di open data}}\\
\vspace{20mm} {\includegraphics[scale=0.15]{unimib.png}}
\end{center}
\vspace{20mm}
\par
\noindent
...
{\large{\bf Relazione della prova finale di:\\
Luca Racchetti\\
Matricola 703311}}
\end{minipage}
\vspace{10mm}
