...
\usepackage{textcomp}
\newcommand{\shellcmd}[1]{\indent\texttt{\footnotesize\textcolor{NavyBlue}{\raisebox{0.5ex}{\texttildelow}\$} #1}\\}
\newcommand{\shellcmdd}[2]{\indent\texttt{\footnotesize\textcolor{NavyBlue}{#1 \$} #2}\\}

\newcommand{\shellcmdenv}[1]{\indent\texttt{\footnotesize\textcolor{NavyBlue}{(default) \textasciitilde{}\$} #1}\\}
\newcommand{\shellcmdenvpath}[1]{\indent\texttt{\footnotesize\textcolor{NavyBlue}{(default) /usr/lib/ckan/default/src/ckan\$} #1}\\}

%\usepackage{listings} %per list are codices



\usepackage{tikz} %pacchetto per il comando successivo
\newcommand*\mycirc[1]{ %per mettere i numeri cerchiati
...
\begin{center}
\vspace{-4.0mm} {\includegraphics[scale=0.07]{img/unimib}}
\end{center}
\end{minipage}
...
%\vspace{20mm} {\includegraphics[scale=0.12]{img/unimib}}
\end{center}
...
\chapter{Introduzione} 
	\input{1.Introduzione/0.Intro}
	\input{1.Introduzione/1.Obiettivo-della-tesi}
	\input{1.Introduzione/2.Struttura}
\newpage %nuova pagina

%-------------------------------------------------------------------------

\chapter{Cosa si intende per Open Data} 
	\input{2.Cosa-si-intende-per-OpenData/1.Movimento-OpenData}
	\input{2.Cosa-si-intende-per-OpenData/2.Impianto-normativo}
\newpage %nuova pagina

%-------------------------------------------------------------------------

\chapter{Piattaforme Tecnologiche} 
	\input{3.Piattaforme-Tecnologiche/1.Socrata-(OpenSource)}
	\input{3.Piattaforme-Tecnologiche/2.Ckan}
	%\input{3.Piattaforme-Tecnologiche/3.Sister.it}
\newpage %nuova pagina

%-------------------------------------------------------------------------

\chapter{Progettazione portale Open Data a Vigevano} 
	\input{4.Progettazione-portale-OpenData-a-Vigevano/1.Descrizione-del-comune}
	\input{4.Progettazione-portale-OpenData-a-Vigevano/2.Progettazione-piattaforma}
	\input{4.Progettazione-portale-OpenData-a-Vigevano/3.Integrazione-con-Regione-Lombardia}
\newpage %nuova pagina

%-------------------------------------------------------------------------

\chapter{Sviluppo della soluzione} 
	\input{5.Sviluppo-della-soluzione/0.Intro}
	%\input{5.Sviluppo-della-soluzione/1.Caricamento-automatico}
	\input{5.Sviluppo-della-soluzione/2.Dizionario-dati}
	%\input{5.Sviluppo-della-soluzione/3.Blueprint}
\newpage %nuova pagina
...
\input{7.Conclusioni-e-sviluppi-futuri}
\newpage %nuova pagina
