...
Per prima cosa  stata installata su macchina virtuale il sistema operativo \href{http://releases.ubuntu.com/precise/ubuntu-12.04.2-desktop-amd64.iso}{\texttt{Ubuntu 12.04 a 64 bit}}, necessario per poter installare CKAN precompilato.\\
...
\subsection{Archiviazione dei file}

Successivamente si sono impostati anche i componenti aggiuntivi \textbf{FileStore} e \textbf{File Uploads}, che contrariamente al FileStore, che fornisce un'archiviazione ÒblobÓ di interi file senza alcun accesso o interrogazione a parti di essi, fanno in modo che CKAN si comporti come un database in cui i singoli elementi del dato sono accessibili e interrogabili.
...
\subsection{Automazione analisi file caricati}
