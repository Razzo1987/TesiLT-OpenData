...
A questo punto si è voluto esportare il risultato della query in un file in formato CSV (comma-separated values) e salvarlo in una posizione che fosse poi recuperabile dal web server, di conseguenza si è scelto di salvarlo nella sua root. Ciò è possibile utilizzando il comando \textit{Copy} dopo aver acceduto al database PostgreSQL:\\
